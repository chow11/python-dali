...
from dali.driver.atxledpi import AtxLEDPi
import sys
import time
...
if __name__ == "__main__":
    ...
    print("Usage: find-ballasts.py [bus prefix]")

    if len(sys.argv) > 1:
        bus_predix = sys.argv[1]
        print("Looking for ballast devices on bus {0}".format(bus_prefix))
    else:
        print("Looking for ballast devices")

    with AtxLEDPi(bus_prefix) as d:
